        ...
        <>
            {result === true ? 
                <Container className="mt-5 rounded-3 d-flex justify-content-center align-items-center flex-column" >
                    <Table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{largura}</td>
                                <td>{altura}</td>
                                <td>{calculatorWeightEstribos(largura, altura, bitola, quantidadeDeFerros)}</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>{bitola}</td>
                                ...
                                <td>{comprimento}</td>
                                <td>{altura - 2}</td>
                                <td>{calculatorWeightEstribos(largura, altura - 2, bitola, quantidadeDeFerros)}</td>
                            </tr>
                        </tbody>
                    </Table>
                    <Card className="mb-2">
                        <Card.Body>Quantidade de Sapatas: {quantidadeDeSapatas}</Card.Body>
                    </Card>
                    ...
                    <Container className="mt-5 mb-5 d-flex justify-content-center align-items-center gap-2 flex-column">
                ...
                : 
                <Form className="m-5 p-5 rounded-3">
                    <Row className="mb-3">
