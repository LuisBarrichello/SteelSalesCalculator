            ...
            <form action="">
                ...
                <div className="form-floating mb-3 mt-3">
                    <input
                        ...
                        className={`form-control ${
                            formState.quantityOfCoil <= 0 ? 'is-invalid' : ''
                        }`}
                        id=""
                        placeholder=""
                        name="quantityOfCoil"
                    ...
                    />
                    <label htmlFor="quantityOfCoil">
                        Digite a quantidade de bobininhas
                    </label>
                    <div className="invalid-feedback">
                        A quantidade de bobinas deve ser maior que zero.
                    </div>
                </div>

                <div className="mb-3 mt-3">
                    <label>Possui cortes?</label>
                    <div className="form-check">
                        <input
                            ...
                            value="true"
                            onChange={(event) =>
                                handleInputChange('hasCuts', event.target.value)
                            }
                        />
                        <label
                    ...
                    <div className="form-check">
                        ...
                        />
                        <label className="form-check-label" htmlFor="hasCutsNo">
                            Não
                        </label>
                    </div>
                </div>
                ...
                <div className="form-floating mb-3 mt-3">
                    <input
                        type="number"
                        className={`form-control ${
                            formState.quantityOfMeters <= 14 ? 'is-invalid' : ''
                        }`}
                        id=""
                        placeholder=""
                    ...
                    />
                    <label htmlFor="quantityOfMeters">
                        Digite a quantidade de metros
                    </label>
                    <div className="invalid-feedback">
                        A quantidade de metros deve ser no mínimo 15 metros
                    </div>
                </div>
                                ...
                                return (
                                    <div
                                        ...
                                        <label htmlFor="cutWidth">
                                            Largura do corte {index + 1}
                                        </label>
                                        <div className="invalid-feedback">
                                            {widthCoil > 1200 ? `A soma dos cortes deve resulta em 1200mm - Excedeu ${
                                                widthCoil - 1200
                                            }mm` : `A soma dos cortes deve resulta em 1200mm - Falta ${
                                                1200 - widthCoil
                                            }mm` }
                                        </div>
                                    </div>
