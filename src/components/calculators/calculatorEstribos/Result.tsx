...
const EstriboCircular = () => <img src={ImgEstriboCircular} alt="estribo circular" style={{ maxWidth: '250px' }}/>;
const EstriboTriangular = () => <img src={ImgEstriboTriangular} alt="estribo triangular" style={{ maxWidth: '250px' }}/>;
const EstriboDefault = () => <img src={ImgEstriboDefault} alt="estribo retangular ou quadrado" style={{ maxWidth: '250px' }}/>;
...
function Result ({ result, resetForm }: ResultProps) {
    ...
    return (
        <>
            ...
            <section className='mb-4 container d-flex justify-content-center align-items-center'>
                    ...
                    <div className="col">
                        ...
                        <div className="card border-danger  mb-3" >
                            <div className="card-body text-dark">
                                <h5 className="card-title">Dobra mínima - transpasses</h5>
                                <p className="card-text">Dobra mínima dos transpasses <strong className="text-danger ">é proporcional a bitola.</strong> Ex: 6.3mm - 6cm
                                </p>
                            </div>
                        </div>
                    </div>
