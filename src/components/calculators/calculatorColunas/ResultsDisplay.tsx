        ...
        <table className="table table-hover mt-3 mb-5 container">
          ...
          <tbody>
            <tr>
              ...
              <td>{result.totalWeightOfBars} kg</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table className="table table-hover mt-3 mb-5 container">
          ...
          <tbody>
            <tr>
              {shape === "rectangular" && (
                <td>
                  {result.stirrupMeasurements?.lengthSides?.length1} x{" "}
                  {result.stirrupMeasurements?.lengthSides?.length2}
                </td>
              )}
              {shape === "triangular" && (
                <td>
                  {result.stirrupMeasurements?.lengthSides?.length1} x{" "}
                  {result.stirrupMeasurements?.lengthSides?.length1} x{" "}
                  {result.stirrupMeasurements?.lengthSides?.length1}
                </td>
              )}
